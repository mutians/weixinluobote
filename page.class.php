...
class Page{
	...
	protected function pageStyle1(){
		/* 构造普通模式的分页 
   		...
   		*/
   		$pageStr = '';
   		if($this->count > $this->subPages){
   			$pageStr.='<ul class="pagination"><li class="disabled"><a href="javascript:void(0)">查询到'.$this->count.'条记录 共'.$this->countPages.'页</a></li>';
   		
	   		$_GET['page_no'] = 1;
	   		if($this->currPage > 1){
	   			$pageStr.='<li class="prev"><a href="'.$this->href.'?'.http_build_query($_GET).'"><i class="fa fa-angle-double-left"></i></a></li>';
	   			$_GET['page_no'] = $this->currPage-1;
	   			$pageStr.='<li class="prev"><a href="'.$this->href.'?'.http_build_query($_GET).'"><i class="fa fa-angle-left"></i></a></li>';
	   		}else{
	   		...
	   		if($this->currPage<$this->countPages){
	   			$_GET['page_no'] = $this->currPage+1;
	   			$pageStr.='<li class="next"><a href="'.$this->href.'?'.http_build_query($_GET).'"><i class="fa fa-angle-right"></i></a></li>';
	   			$_GET['page_no'] = $this->countPages;
	   		$pageStr.='<li class="next"><a href="'.$this->href.'?'.http_build_query($_GET).'"><i class="fa fa-angle-double-right"></i></a></li></ul>';
			}else{
				$_GET['page_no'] = $this->currPage+1;
	   			$pageStr.='<li class="next disabled"><a href="#"><i class="fa fa-angle-right"></i></a></li>';
	   			$_GET['page_no'] = $this->countPages;
	   		$pageStr.='<li class="next disabled"><a href="#"><i class="fa fa-angle-double-right"></i></a></li></ul>';
			}
		}
   		return $pageStr;
	}
